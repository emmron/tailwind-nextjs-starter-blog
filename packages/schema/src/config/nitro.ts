...
/**
 * Simplified Rollup configuration for Nitro.
 * This separate type helps prevent "Type instantiation is excessively deep and possibly infinite" errors.
 */
export interface NitroRollupConfig {
...
export default defineResolvers({
  ...
  nitro: {
    ...
    // Use the separate NitroRollupConfig interface to break recursive type chain
    rollupConfig: {} as NitroRollupConfig,
  },
